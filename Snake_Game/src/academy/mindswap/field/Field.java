...
public final class Field {
    ...
    public static void init(int width, int height) {
     ...
     //responsável por desenhar a cobra no terminal ou na tela
    public static void drawSnake(Snake snake) {
        LinkedList<Position> body = snake.getFullSnake();
        Position  head = snake.getHead();
        Terminal.Color snakeColor;

       if(snake.isAlive()){
          snakeColor = Terminal.Color.GREEN;
       } else {
